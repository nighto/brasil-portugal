...
- [**Familiar de Cidadão Europeu**], não precisa de visto, apenas o passaporte válido do cidadão europeu, o passaporte do(s) familiare(s) válidos e certidão de casamento apostilada (no caso de conjugês) e certidões de nascimento apostilada (no caso de filhos). Não há necessidade da certidão de casamento ou nascimento estar registrada no estado de origem da cidadania européia, a certidão de casamento/nascimento emitidas no Brasil e apostiladas servem para entrada em Portugal.
