...
[Verifique uma relação com os postos de controlo da DGAV neste link (PDF)](http://www.dgv.min-agricultura.pt/xeov21/attachfileu.jsp?look_parentBoui=177845&att_display=n&att_download=y&usg=AOvVaw1NvVqbb1vdGxWyoDxlmyuv).
...
Os exames teóricos e práticos podem ser feitas no IMT (equivalente do Detran) ou em diversas instituições privadas afiliadas ao IMT. A escola de condução que fiz tem parceria com a ACP (Automóvel Clube do Porto) de forma que o exame foi feito lá.
...
![Tabela de valores de auxílio](https://user-images.githubusercontent.com/397851/100441435-c0115d80-30a6-11eb-8dcf-724331a2a36b.png)
...
Na prática, caso você escolha se mudar para um país que _não_ tenha acordo para evitar bitributação você poderia optar pela saída com caráter permanente com o objetivo de não ter que pagar imposto de renda no Brasil pelos ganhos obtidos no novo país no primeiro ano, mas novamente não é o caso de Portugal.
...
![captura de tela do andamento do pedido](https://user-images.githubusercontent.com/397851/118373661-f76dbb00-b5af-11eb-9339-358f1cc5ba8b.png)
...
- [termo de responsabilidade](https://www.sef.pt/pt/Documents/TR_Fronteiras.pdf) (PDF do SEF aonde vc declara ser responsável pelas despesas da pessoa);
